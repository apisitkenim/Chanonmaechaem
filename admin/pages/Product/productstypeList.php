          ...
          <div class="box">
            <div class="box-header with-border">
              ...
              <div class="box-tools pull-right">
                                <a id="body_btnAdd" class="btn btn-search btn-primary btn-sm" href="productstypeInfo.php?id=0"><i class="fa fa-plus xs"></i>&nbsp;&nbsp;เพิ่มประเภทสินค้า</a>
                            </div>
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                     ...
                     <tr>
                       ...
                       <td><?php echo $row['productstypecode']; ?></td>
                         <td><?php echo $row['productstypename']; ?></td>
                         <td align="center">
                         <a onclick="editOnclick(<?php echo $row['productstypeid']; ?>)"><i class="fa fa-edit md"></i></a>
                       </td>
                         <td align="center">
                         <a onclick="DelOnclick(<?php echo $row['productstypeid']; ?>)"><i class="fa fa-remove md"></i></a>
                       </td>
                     </tr>
