...
$sql1 = "SELECT * FROM orders WHERE  statusnow = 'สั่งซื้อสินค้า'";
$select_all1 = $conn->queryRaw($sql1);
$total1 = sizeof($select_all1);

$sql2 = "SELECT * FROM orders WHERE  statusnow = 'ชำระเงินแล้ว'";
$select_all2 = $conn->queryRaw($sql2);
$total2 = sizeof($select_all2);

$sql3= "SELECT * FROM orders WHERE  statusnow = 'รอจัดส่งสินค้า'";
$select_all3 = $conn->queryRaw($sql3);
$total3 = sizeof($select_all3);
      ...
      <div class="row">
        <div class="col-md-4 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">สั่งซื้อสินค้า</span>
              <span class="info-box-number"><?php echo $total1; ?> รายการ <span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-4 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">ชำระเงินแล้ว</span>
              <span class="info-box-number"><?php echo $total2; ?> รายการ</span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-4 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">รอจัดส่งสินค้า</span>
              <span class="info-box-number"><?php echo $total3; ?> รายการ</span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
...
$(document).ready(function () {
  ...
  function editOnclick(id) {
      window.location = '../Orders/orderInfo.php?id=' + id;
  }
</script>
</body>
</html>
