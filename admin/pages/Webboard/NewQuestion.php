...
if($cmd == 'delete'){
  //delete
    if($conn->delete("webboard",array("QuestionID"=>$id))){
        alertMassageAndRedirect('ลบข้อมูลเรียบร้อยแล้ว','Webboard.php');
    }else{
    alertMassageAndRedirect('ไม่สามารถลบข้อมูลได้','Webboard.php');
    }
  }
            ...
            <form class="form-horizontal">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="inputEmail3" name="_Question" placeholder="หัวข้อ" value="<?php echo $code ?>" required=required>
                  </div>
                </div>
                <div class="form-group">
