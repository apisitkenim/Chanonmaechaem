...
if($cmd == 'save'){
  $value = array(
      "amount"=>getIsset('_amount')
  );

               if ($conn->update("products", $value, array("productid" => $id))) {
                   alertMassageAndRedirect('บันทึกข้อมูลเรียบร้อยแล้ว','StockList.php');
               }else{
            ...
            <form class="form-horizontal" method="post" >
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="inputEmail3" name="_code" placeholder="รหัสสินค้า" value="<?php echo $productscode ?>" disabled required=required>
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="inputEmail3" name="_name" placeholder="ชื่อสินค้า" value="<?php echo $productsname ?>" disabled required=required>
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    <select class="form-control" name="_type" required=required disabled>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="number" class="form-control txtNumber" id="inputEmail3" name="_price" placeholder="ราคา" value="<?php echo $productsprice ?>" disabled required=required>
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    <select class="form-control" name="_typeProduct" required=required disabled>
